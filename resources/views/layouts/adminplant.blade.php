...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="journal-plus" viewBox="0 0 16 16">
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" aria-label="nav">
          <div class="container-fluid">
              ...
              <ul class="nav nav-pills ms-auto">
                <li class="nav-item">
                  <a href="{{route('admin.create')}}" class="nav-link link-dark">
                    <svg class="bi me-2" width="16" height="16"><use xlink:href="#journal-plus"/></svg>
                    Registro
                  </a>
                </li>
                <li>
                  <a href="{{route('admin.show')}}" class="nav-link link-dark">
                ...
                @if (Auth::user()->tipo == "admin")
                  <div class="dropdown">
                    <a href="{{route('admin.users')}}" class="nav-link link-dark dropdown-toggle" id="userv" data-bs-toggle="dropdown" aria-expanded="false">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
                      Usuarios
                    </a>
                    <ul class="dropdown-menu text-small shadow" aria-labelledby="userv">
                      <li><a class="dropdown-item" href="{{route('admin.showu')}}">Ver usuarios</a></li>
                      <li><a class="dropdown-item" href="{{route('admin.users')}}">Registar usuarios</a></li>
                    </ul>
                  </div>
                @endif
                </li>
